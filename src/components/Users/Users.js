...
export const Users = (props) => {
    ...
    return (
        <div>
            ...
            <span>
                <div>
                    <img src={m.photoUrl} className={styles.picture}/>
                </div>
                <div>
                    {m.followed
                    ...
                    <span><div className={styles.marg}>{m.fullName}</div><div
                        className={styles.marg}>{m.status}</div></span>
                    <span><div className={styles.marg}>{m.location.country}</div><div
                        className={styles.marg}>{m.location.city}</div></span>
                </div>)}
        </div>
    )
}
